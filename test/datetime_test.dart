...
void main() {
  ...
  test('isBeforeDate test', () {
    expect(DateTime.now().subtract(Duration(seconds: 10)).isBeforeDate(DateTime.now()), false);
    expect(DateTime.now().subtract(Duration(hours: 24)).isBeforeDate(DateTime.now()), true);
  });

  test('isAfterDate test', () {
    expect(DateTime.now().add(Duration(seconds: 10)).isAfterDate(DateTime.now()), false);
    expect(DateTime.now().add(Duration(hours: 24)).isAfterDate(DateTime.now()), true);
  });

  test('isSameOrAfterDate test', () {
    expect(DateTime.now().add(Duration(seconds: 10)).isSameOrAfterDate(DateTime.now()), true);
    expect(DateTime.now().add(Duration(hours: 24)).isSameOrAfterDate(DateTime.now()), true);
    expect(DateTime(2025, 1, 26, 9, 10).isSameOrAfterDate(DateTime(2025, 1, 10, 23, 2)), true);
    expect(DateTime(2025, 1, 20, 9, 10).isSameOrAfterDate(DateTime(2025, 1, 26, 23, 2)), false);
    expect(DateTime(2025, 1, 26, 9, 10).isSameOrAfterDate(DateTime(2025, 1, 26, 10, 10)), true);
  });

  test('isSameOrBeforeDate test', () {
    expect(DateTime.now().subtract(Duration(seconds: 10)).isSameOrBeforeDate(DateTime.now()), true);
    expect(DateTime.now().subtract(Duration(hours: 24)).isSameOrBeforeDate(DateTime.now()), true);
    expect(DateTime(2025, 1, 26, 9, 10).isSameOrBeforeDate(DateTime(2025, 1, 10, 23, 2)), false);
    expect(DateTime(2025, 1, 20, 9, 10).isSameOrBeforeDate(DateTime(2025, 1, 26, 23, 2)), true);
    expect(DateTime(2025, 1, 26, 9, 10).isSameOrBeforeDate(DateTime(2025, 1, 26, 10, 10)), true);
  });

  test('isSameDateAs test', () {
    expect(DateTime.now().add(Duration(seconds: 10)).isSameDateAs(DateTime.now()), true);
    expect(!DateTime.now().add(Duration(hours: 24)).isSameDateAs(DateTime.now()), true);
  });
  ...
  test('isBetween extension tests', () {
    expect(DateTime.now().isBetween(DateTime.now() - 2.days, DateTime.now() + 2.days), true);
  ...
  test('format tests', () {
    ...
    expect(date.format('dd-mm-yyyy hh:mm:ss'), DateFormat('dd-mm-yyyy hh:mm:ss').format(date));
  });
