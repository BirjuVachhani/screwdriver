...
| [`appendStringSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L106) | `METHOD` |  Appends `value` string at the end of the file using provided `encoding`. |
| [`appendStringLine`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L115) | `METHOD` |  Appends `value` string as a new line at the end of the file using  provided `encoding`. |
| [`appendBytes`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L123) | `METHOD` |  Appends `value` bytes at the end of the file. |
| [`appendBytesSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L131) | `METHOD` |  Appends `value` bytes at the end of the file. |
| [`appendFrom`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L139) | `METHOD` |  Appends content of `file` at the end of `this` file. |
| [`appendFromSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L147) | `METHOD` |  Appends content of `file` at the end of `this` file. |
| [`createIfMissing`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L156) | `METHOD` |  Creates the file if it does not exist.  Returns the file instance. |
| [`createIfMissingSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L164) | `METHOD` |  Synchronously creates the file if it does not exist. |
| [`deleteIfExists`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L170) | `METHOD` |  Deletes the file if it exists.  Returns the deleted file instance or `this` if the file did not exist. |
| [`deleteIfExistsSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L176) | `METHOD` |  Synchronously deletes the file if it exists. |
| [`readBytesRange`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L187) | `METHOD` |  Synchronously reads a byte range from `this` file. |
| [`streamLines`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L214) | `METHOD` |  Streams the content of `this` file as lines of text. |
