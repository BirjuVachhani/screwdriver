...
## Table of Contents
| Extension on (28) | Functions (22) | Helper Classes (5) | Extension Type (4) |
|---|---|---|---|
...
| [Comparable\<dynamic\>](#on-comparabledynamic) | [now](#functions) | [IntRangeIterator](#helper-classes) | [Turns](#turns) |
...
| [List\<int\>](#on-listint) | [randomBool](#functions) |  |  |
...
| [Map\<K, V\>](#on-mapk,-v) | [randomString](#functions) |  |  |
...
| [StringBuffer](#on-stringbuffer) | [tryCatchOnly](#functions) |  |  |
| [bool](#on-bool) | [tryCatch](#functions) |  |  |
| [double](#on-double) | [checkLeapYear](#functions) |  |  |
| [int](#on-int) | [tryJsonDecode](#functions) |  |  |
| [num](#on-num) | [isExactType](#functions) |  |  |
| [num](#on-num) | [isSubType](#functions) |  |  |
| [num?](#on-num) |  |  |  |
| [Object?](#on-object) |  |  |  |
| [String](#on-string) |  |  |  |
| [String?](#on-string) |  |  |  |
...
| [`randomOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L299) | `METHOD` |  Returns a random element from `this`. Returns null if no elements  are present. |
| [`random`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L307) | `METHOD` |  Returns a random element from `this`.  Throws `StateError` if there are no elements in the collection. |
| [`onEach`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L315) | `METHOD` |  Performs the given `action` on each element and returns the  iterable itself afterwards. |
| [`maxByOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L319) | `METHOD` |  Returns the first element yielding the largest value of the given  function or `null` if there are no elements. |
...
| [`maxByLast`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L372) | `METHOD` |  Returns the last element yielding the largest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`minByOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L389) | `METHOD` |  Returns the first element yielding the smallest value of the given  function or `null` if there are no elements. |
| [`minBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L407) | `METHOD` |  Returns the first element yielding the smallest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`minByLastOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L424) | `METHOD` |  Returns the last element yielding the smallest value of the given  function or `null` if there are no elements. |
| [`minByLast`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L442) | `METHOD` |  Returns the last element yielding the smallest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`sumBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L459) | `METHOD` |  Returns the sum of all values produced by `selector` function  applied to each element in the collection. |
| [`averageBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L464) | `METHOD` |  Returns the average of all values produced by `selector` function  applied to each element in the collection. |
| [`except`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L470) | `METHOD` |  Alias for `subtract`. |
| [`exceptAll`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L487) | `METHOD` |  Alias for `subtract`. |
| [`containsAll`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L491) | `METHOD` |  Returns true if the collection contains all the elements  present in `other` collection. |
| [`containsNone`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L495) | `METHOD` |  Returns true if the collection doesn't contain any of the elements  present in `other` collection. |
| [`findBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L499) | `METHOD` |  Finds an element where the result of `selector` matches the `query`.  Throws `StateError` if no element is found. |
| [`findByOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L508) | `METHOD` |  Finds an element where the result of `selector` matches the `query`.  Returns null if no element is found. |
| [`findAllBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L517) | `METHOD` |  Finds all elements where the result of `selector` matches the `query`.  Returns empty collection if no element is found. |


### on `Iterable<E>?`
| Extension | Type | Description |
|---|---|---|
| [`isNullOrEmpty`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L527) | `GETTER` |  Returns true if `this` is either null or empty collection. |
| [`isBlank`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L534) | `GETTER` |  Alias for `isNullOrEmpty`.  Returns true if `this` is either null or empty collection. |
| [`isNotBlank`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L538) | `GETTER` |  Alias for `isNotNullOrEmpty`.  Returns true if `this` is neither null nor empty collection. |
| [`isNotNullOrEmpty`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L541) | `GETTER` |  Returns true if `this` is neither null nor empty collection. |


### on `List<int>`
| Extension | Type | Description |
|---|---|---|
| [`toBase64`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L551) | `METHOD` |  Converts the list of integers to a base64 encoded string. e.g. converting  bytes to base64 string. |
| [`toUint8List`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L554) | `METHOD` |  Converts `this` list of integers to a `Uint8List`. |
| [`toUint16List`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L557) | `METHOD` |  Converts `this` list of integers to a `Uint16List`. |


### on `Iterable<Iterable<E?>?>?`
| Extension | Type | Description |
|---|---|---|
| [`flattenedNotNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L563) | `GETTER` |  Flattens the nested iterable to a single iterable. |
