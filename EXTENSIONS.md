...
## Table of Contents
| Extension on (30) | Functions (22) | Helper Classes (5) | Extension Type (4) |
|---|---|---|---|
| [Future\<R\>](#on-futurer) | [post](#functions) | [DeBouncer](#helper-classes) | [Degrees](#degrees) |
| [Stream\<E\>](#on-streame) | [postDelayed](#functions) | [IntRange](#helper-classes) | [Radians](#radians) |
| [Stream\<E?\>](#on-streame) | [now](#functions) | [IntRangeIterator](#helper-classes) | [Turns](#turns) |
| [Comparable\<dynamic\>](#on-comparabledynamic) | [TODO](#functions) | [IllegalArgumentException](#helper-classes) | [TryCatchError](#trycatcherror) |
| [Iterable\<E\>](#on-iterablee) | [runCaching](#functions) | [IllegalStateException](#helper-classes) |  |
| [Iterable\<E\>?](#on-iterablee) | [randomBool](#functions) |  |  |
| [Iterable\<Iterable\<E?\>?\>?](#on-iterableiterablee) | [randomDouble](#functions) |  |  |
| [Iterator\<E\>](#on-iteratore) | [randomInt](#functions) |  |  |
| [List\<E\>](#on-liste) | [buildString](#functions) |  |  |
| [List\<int\>](#on-listint) | [randomString](#functions) |  |  |
| [Map\<K, V\>](#on-mapk,-v) | [complete](#functions) |  |  |
| [Set\<E\>](#on-sete) | [debounce](#functions) |  |  |
| [DateTime](#on-datetime) | [checkNotNull](#functions) |  |  |
| [Duration](#on-duration) | [check](#functions) |  |  |
| [Object?](#on-object) | [requireNotNull](#functions) |  |  |
| [Object](#on-object) | [require](#functions) |  |  |
| [Iterable\<T\>](#on-iterablet) | [tryCatchOnly](#functions) |  |  |
| [Pattern](#on-pattern) | [tryCatch](#functions) |  |  |
| [StringBuffer](#on-stringbuffer) | [checkLeapYear](#functions) |  |  |
| [bool](#on-bool) | [tryJsonDecode](#functions) |  |  |
| [double](#on-double) | [isExactType](#functions) |  |  |
| [int](#on-int) | [isSubType](#functions) |  |  |
| [num](#on-num) |  |  |  |
| [num](#on-num) |  |  |  |
| [num?](#on-num) |  |  |  |
| [Object?](#on-object) |  |  |  |
...
| [`asCompleter`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/async/future.dart#L87) | `METHOD` |  Converts this `Future` into a `Completer`. |


### on `Stream<E>`
| Extension | Type | Description |
|---|---|---|
| [`waitFor`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/async/stream.dart#L40) | `METHOD` |  Waits for the stream to emit the specified `item` and returns it. |
| [`whereType`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/async/stream.dart#L43) | `METHOD` |  Returns a new stream that emits only values of type `R` from the original stream. |


### on `Stream<E?>`
| Extension | Type | Description |
|---|---|---|
| [`nonNulls`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/async/stream.dart#L49) | `GETTER` |  Returns a new stream that emits only non-null values from the original stream. |
...
| [`filter`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L81) | `METHOD` |  alias for `Iterable.where` |
| [`filterIndexed`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L84) | `METHOD` |  alias for `whereIndexed` which returns a new lazy Iterable. |
| [`flatMap`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L92) | `METHOD` |  alias for `Iterable.map` |
| [`flatMapNotNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L99) | `METHOD` |  alias for `Iterable.map` |
| [`mapNotNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L112) | `METHOD` |  Similar to `Iterable.map` but also filters out null values. |
| [`mapNotNullIndexed`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L126) | `METHOD` |  Similar to `List.mapIndexed`, where index is also provided to the  `transform` function, but also filters out null values. |
| [`drop`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L134) | `METHOD` |  alias for `Iterable.skip` |
| [`takeLast`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L137) | `METHOD` |  alias for `Iterable.skip` |
| [`dropWhile`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L145) | `METHOD` |  alias for `Iterable.skipWhile` |
| [`dropLast`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L148) | `METHOD` |  alias for `Iterable.skip` |
| [`all`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L156) | `METHOD` |  alias for `Iterable.every` |
| [`toMap`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L161) | `METHOD` |  Alias for `associate`.  Returns a `Map` containing key-value pairs provided by `transform`  function applied to elements of the given List. |
| [`associate`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L165) | `METHOD` |  Returns a `Map` containing key-value pairs provided by `transform`  function applied to elements of the given List. |
...
| [`associateWith`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L192) | `METHOD` |  Returns a `Map` where keys are elements from the given iterable  and values are produced by the `valueSelector` function  applied to each element. |
| [`associateWithTo`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L198) | `METHOD` |  Populates and returns the `destination` map with key-value  pairs for each element of the given iterable,  where key is the element itself and value is provided  by the `valueSelector` function applied to that key. |
| [`groupBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L206) | `METHOD` |  Groups elements of the original iterable by the key returned by  the given `keySelector` function applied to each element  and returns a map where each group key is associated with a  list of corresponding elements. |
| [`groupByTo`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L212) | `METHOD` |  Groups elements of the original iterable by the key returned by  the given `keySelector` function applied to each element  and puts to the `destination` map each group key associated  with a list of corresponding elements. |
| [`distinct`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L223) | `METHOD` |  Returns an iterable containing only distinct elements from  the given iterable. |
| [`distinctBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L227) | `METHOD` |  Returns an iterable containing only elements from the given iterable  having distinct keys returned by the given `selector` function. |
| [`distinctByTo`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L232) | `METHOD` |  Populates and returns the `destination` list with containing only  elements from the given iterable having distinct keys returned by  the given `selector` function. |
| [`intersect`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L243) | `METHOD` |  Returns a set containing all elements that are contained by both  `this` iterable and the `other` iterable. |
| [`subtract`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L247) | `METHOD` |  Returns a set containing all elements that are contained by `this`  iterable and not contained by the `other` iterable. |
| [`union`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L250) | `METHOD` |  Returns an iterable containing all distinct elements from both iterables. |
| [`countBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L253) | `METHOD` |  Returns the number of elements matching the given `predicate`. |
| [`count`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L263) | `METHOD` |  Returns the number of elements matching the given `predicate`. |
| [`foldRight`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L274) | `METHOD` |  Accumulates value starting with `initialValue` value and  applying `operation` from right to left to each element  and current accumulator value. |
| [`foldRightIndexed`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L287) | `METHOD` |  Accumulates value starting with `initialValue` value and applying  `operation` from right to left to each element with its index in  the original list and current accumulator value. |
| [`randomOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L311) | `METHOD` |  Returns a random element from this iterable. |
| [`random`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L345) | `METHOD` |  Returns a random element from this iterable. |
| [`onEach`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L369) | `METHOD` |  Performs the given `action` on each element and returns the  iterable itself afterwards. |
| [`maxByOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L373) | `METHOD` |  Returns the first element yielding the largest value of the given  function or `null` if there are no elements. |
| [`maxBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L391) | `METHOD` |  Returns the first element yielding the largest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`maxByLastOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L408) | `METHOD` |  Returns the last element yielding the largest value of the given  function or `null` if there are no elements. |
| [`maxByLast`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L426) | `METHOD` |  Returns the last element yielding the largest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`minByOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L443) | `METHOD` |  Returns the first element yielding the smallest value of the given  function or `null` if there are no elements. |
| [`minBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L461) | `METHOD` |  Returns the first element yielding the smallest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`minByLastOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L478) | `METHOD` |  Returns the last element yielding the smallest value of the given  function or `null` if there are no elements. |
| [`minByLast`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L496) | `METHOD` |  Returns the last element yielding the smallest value of the given  function.  Throws `StateError` if there are no elements in the collection. |
| [`sumBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L513) | `METHOD` |  Returns the sum of all values produced by `selector` function  applied to each element in the collection. |
| [`averageBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L518) | `METHOD` |  Returns the average of all values produced by `selector` function  applied to each element in the collection. |
| [`except`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L524) | `METHOD` |  Alias for `subtract`. |
| [`exceptAll`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L541) | `METHOD` |  Alias for `subtract`. |
| [`containsAll`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L545) | `METHOD` |  Returns true if the collection contains all the elements  present in `other` collection. |
| [`containsNone`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L549) | `METHOD` |  Returns true if the collection doesn't contain any of the elements  present in `other` collection. |
| [`findBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L553) | `METHOD` |  Finds an element where the result of `selector` matches the `query`.  Throws `StateError` if no element is found. |
| [`findByOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L562) | `METHOD` |  Finds an element where the result of `selector` matches the `query`.  Returns null if no element is found. |
| [`findAllBy`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L571) | `METHOD` |  Finds all elements where the result of `selector` matches the `query`.  Returns empty collection if no element is found. |
| [`toStream`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L586) | `METHOD` |  Converts this iterable into a stream. |


### on `Iterable<E>?`
| Extension | Type | Description |
|---|---|---|
| [`isNullOrEmpty`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L604) | `GETTER` |  Returns true if `this` is either null or empty collection. |
| [`isBlank`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L611) | `GETTER` |  Alias for `isNullOrEmpty`.  Returns true if `this` is either null or empty collection. |
| [`isNotBlank`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L615) | `GETTER` |  Alias for `isNotNullOrEmpty`.  Returns true if `this` is neither null nor empty collection. |
| [`isNotNullOrEmpty`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L618) | `GETTER` |  Returns true if `this` is neither null nor empty collection. |


### on `Iterable<Iterable<E?>?>?`
| Extension | Type | Description |
|---|---|---|
| [`flattenedNotNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/iterable.dart#L627) | `GETTER` |  Flattens the nested iterable to a single iterable. |
...
| [`randomOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/list.dart#L83) | `METHOD` |  Returns a random element from this list. |
| [`random`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/list.dart#L100) | `METHOD` |  Returns a random element from this list. |


### on `List<int>`
| Extension | Type | Description |
|---|---|---|
| [`toBase64`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/list.dart#L113) | `METHOD` |  Converts the list of integers to a base64 encoded string. e.g. converting  bytes to base64 string. |
| [`toUint8List`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/list.dart#L116) | `METHOD` |  Converts `this` list of integers to a `Uint8List`. |
| [`toUint16List`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/list.dart#L119) | `METHOD` |  Converts `this` list of integers to a `Uint16List`. |
...
| [`records`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L107) | `GETTER` |  Similar to `Map.entries` but returns an iterable of records instead of  `MapEntry`. |
...
| [`>>`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L53) | `METHOD` |  Allows to remove a key from `this`. |
| [`toJson`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L57) | `METHOD` |  Converts `this` map into a JSON string. |
| [`toJsonString`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L60) | `METHOD` |  Converts `this` map into a JSON string. |
| [`except`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L64) | `METHOD` |  Returns a new `Map` with the same keys and values as `this` except  keys present `keys`. |
| [`only`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L68) | `METHOD` |  Returns a new `Map` with the same keys and values but only contains  the keys present in `keys`. |
| [`take`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L74) | `METHOD` |  Alias for `only` method. |
| [`where`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L78) | `METHOD` |  Returns a new `Map` with the same keys and values as `this` where the  key-value pair satisfies the `test` function. Similar to `Iterable.where`. |
| [`whereKey`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L85) | `METHOD` |  Returns a new `Map` with the same keys and values as `this` where the  key satisfies the `test` function. |
| [`whereNot`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L92) | `METHOD` |  Returns a new `Map` with the same keys and values as `this` where the  key-value pair doesn't satisfy the `test` function. |
| [`removeKeys`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L116) | `METHOD` |  Removes all the keys present in `keys` from `this` map. If `this` is  an instance of `UnmodifiableMapBase`, it will return a new map with  the same keys and values except the keys present in `keys`. |
| [`findByValue`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L122) | `METHOD` |  Finds the first key-value pair where the value is equal to `value`. |
| [`findByValueOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L126) | `METHOD` |  Finds the first key-value pair where the value is equal to `value`.  Returns `null` if no such key-value pair is found. |
| [`containsAll`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L129) | `METHOD` |  Checks if the map contains all the keys present in `keys`. |
| [`containsAny`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L132) | `METHOD` |  Checks if the map contains any of the keys present in `keys`. |
| [`containsNone`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L135) | `METHOD` |  Checks if the map contains none of the keys present in `keys`. |
| [`containsOnly`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/map.dart#L138) | `METHOD` |  Checks if the map contains only the keys present in `keys`. |


### on `Set<E>`
| Extension | Type | Description |
|---|---|---|
| [`randomOrNull`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/set.dart#L48) | `METHOD` |  Returns a random element from this set. |
| [`random`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/collection/set.dart#L68) | `METHOD` |  Returns a random element from this set. |
...
| [`previousDay`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/datetime/date_time.dart#L174) | `GETTER` |  Returns `DateTime` with previous day |
...
| [`count`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/primitive/string.dart#L174) | `METHOD` |  Returns count of given `match` in this string |
...
| [`deleteIfExists`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/directory.dart#L67) | `METHOD` |  Deletes the directory and its contents if it exists. |
| [`deleteIfExistsSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/directory.dart#L75) | `METHOD` |  Synchronously deletes the directory and its contents if it exists. |
| [`createIfMissing`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/directory.dart#L81) | `METHOD` |  Creates the directory if it does not exist.  Returns the directory instance. |
| [`createIfMissingSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/directory.dart#L87) | `METHOD` |  Synchronously creates the directory if it does not exist. |


### on `File`
| Extension | Type | Description |
|---|---|---|
| [`isEmpty`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L67) | `GETTER` |  Returns a `Future` containing a `bool` indicating whether  `this` file is empty or not. |
| [`isEmptySync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L70) | `GETTER` |  Returns true if `this` file is empty. |
| [`<<`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L73) | `METHOD` |  Appends `value` to `this` file using UTF-8 encoding. |
| [`+`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L76) | `METHOD` |  Appends the content of `file` to `this` file. |
| [`copyTo`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L80) | `METHOD` |  Asynchronously copies the content of `this` to `other`, overwriting  `other` if it already exists. |
| [`copyToSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L91) | `METHOD` |  Synchronously copies the content of `this` to `other`, overwriting  `other` if it already exists. |
| [`clear`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L113) | `METHOD` |  Asynchronously truncates `this` file to zero bytes, leaving it empty. |
| [`clearSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L118) | `METHOD` |  Synchronously truncates `this` file to zero bytes, leaving it empty. |
| [`onModified`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L122) | `METHOD` |  Calls `block` whenever the `this` file is modified.  Returns `StreamSubscription` which allows to cancel the listener. |
| [`onDeleted`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L128) | `METHOD` |  Calls `block` whenever the `this` file is deleted.  Returns `StreamSubscription` which allows to cancel the listener. |
| [`appendString`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L133) | `METHOD` |  Appends `value` to `this` file using `encoding` (defaults to UTF-8). |
| [`appendStringSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L141) | `METHOD` |  Synchronously appends `value` to `this` file using `encoding` (defaults to UTF-8). |
| [`appendStringLine`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L150) | `METHOD` |  Appends `value` followed by a newline to `this` file using `encoding`  (defaults to UTF-8). |
| [`appendBytes`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L158) | `METHOD` |  Asynchronously appends the raw `value` bytes to `this` file. |
| [`appendBytesSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L166) | `METHOD` |  Synchronously appends the raw `value` bytes to `this` file. |
| [`appendFrom`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L174) | `METHOD` |  Asynchronously appends the entire content of `file` to `this` file. |
| [`appendFromSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L182) | `METHOD` |  Synchronously appends the entire content of `file` to `this` file. |
| [`createIfMissing`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L194) | `METHOD` |  Creates `this` file if it does not already exist and returns it. |
| [`createIfMissingSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L206) | `METHOD` |  Synchronously creates `this` file if it does not already exist. |
| [`deleteIfExists`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L214) | `METHOD` |  Deletes `this` file if it exists and returns the deleted entity, or  returns `this` unchanged if the file did not exist. |
| [`deleteIfExistsSync`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L222) | `METHOD` |  Synchronously deletes `this` file if it exists. |
| [`readBytesRange`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L233) | `METHOD` |  Synchronously reads a byte range from `this` file. |
| [`streamLines`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L260) | `METHOD` |  Streams the content of `this` file as lines of text. |
| [`tailLines`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/io/file.dart#L283) | `METHOD` |  Returns the last `count` lines of `this` file. |
...
| [`isExactType`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/src/utils.dart#L69) |  Checks whether `T1` and `T2` are exactly the same type. |
| [`isSubType`](https://github.com/BirjuVachhani/screwdriver/blob/main/lib/src/utils.dart#L73) |  Checks whether `Sub` is a subtype of `Parent`.  This is a nice little trick that uses Dart's type system to check for subtyping |
